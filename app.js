...
const displaySubjectsCount = () => {
    ...
    for (let count = 1; count <= subjectsCount; count += 1) {
        ...
        optionO.innerHTML = `O Grade(10)`;

        const optionA1 = document.createElement("option");
        optionA1.innerHTML = `A1 Grade(9)`;

        const optionA = document.createElement("option");
        optionA.innerHTML = `A Grade(8)`;

        const optionB1 = document.createElement("option");
        optionB1.innerHTML = `B1 Grade(7)`;

        const optionB = document.createElement("option");
        optionB.innerHTML = `B Grade(6)`;

        const optionC = document.createElement("option");
        optionC.innerHTML = `C Grade(5)`;

        const optionU = document.createElement("option");
        optionU.innerHTML = `U Grade(0)`;

        grade.appendChild(optionSelect)
        grade.appendChild(optionO)
        grade.appendChild(optionA1)
        grade.appendChild(optionA)
        grade.appendChild(optionB1)
